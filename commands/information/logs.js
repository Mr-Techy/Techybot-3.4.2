...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        let embed5 = new MessageEmbed().setTitle('Log #5').addField('Added music commands.', 'Allows you to play music within Discord!').setColor('BLUE');

        const pages = [embed5, embed4, embed3, embed2, embed1];
